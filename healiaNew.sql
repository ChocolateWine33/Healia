...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2023 at 01:36 PM
...
(1, 'admin.png', 'Nada', 'nada@gmail.com', '1522');
...
(24, NULL, 'bola', 'sherif', 'male', '2000-06-03', 'bola@gmail.com', '000', 27),
(25, NULL, 'rana', 'sabry', 'female', '1997-01-22', 'rana@gmail.com', '147', 26),
...
INSERT INTO `payment` (`Payment_ID`, `Card_no`, `expiry_date`, `cvv`, `name`, `paydate`, `Total_Value`, `Request_Id`, `Sub_ID`) VALUES
(17, '2222888855559999', '2023-12-01', '555', 'rana', '2023-06-17', '1500.00', NULL, 19),
(33, '14785236914725', '2023-04-01', '258', 'bola', '2023-06-17', '850.00', NULL, NULL);
...
INSERT INTO `phonenumber` (`Therapist_Id`, `Phone`) VALUES
(1, '01025741828'),
(1, '01225874999');
...
INSERT INTO `request` (`Request_Id`, `Therapist_ID`, `P_ID`, `Status`, `Date`, `TimeFrom`, `TimeTo`, `Request_Value`, `Rating`) VALUES
(1, 1, 25, 'Reserved', '2023-06-27', '15:00:00', '16:00:00', 200, NULL),
(2, 2, 25, 'Cancelled', '2023-06-30', '17:00:00', '18:00:00', 850, NULL),
(3, 3, 25, 'Reserved', '2023-07-06', '15:00:00', '16:00:00', 200, NULL),
(4, 2, 24, 'Reserved', '2023-08-18', '15:00:00', '16:00:00', 850, NULL);
...
(5, 1, '2023-06-27', '15:00:00', '04:00:00'),
(7, 3, '2023-07-06', '15:00:00', '04:00:00');
...
INSERT INTO `sub_plan` (`Sub_ID`, `Start_Date`, `End_Date`, `status`, `Admin-ID`, `Book_ID`, `Group_ID`, `Event_ID`) VALUES
(15, '2023-06-14 21:00:00', '2023-06-15 16:30:56', 'active', NULL, NULL, NULL, 2),
(19, '2023-06-16 21:00:00', '2023-07-16 21:00:00', 'active', NULL, NULL, NULL, NULL),
(26, '2023-06-16 21:00:00', '2023-06-17 12:10:30', 'active', NULL, NULL, 5, 1),
(27, '2023-06-16 21:00:00', '2023-07-16 21:00:00', 'active', NULL, NULL, NULL, NULL);
...
(2, 'Sahar Daoud', 'female', '1989-04-11', 'Master of Science Applied Psychology from Liverpool University', 'Child Learning Disorders ', 5, 'sahar@gmail.com', '336699', '158.jpeg', 'Accepted', 850, 'therapists/Resume.pdf'),
(3, 'Manal Mostafa', 'Female', '1990-05-02', 'Cognitive Behavioral Therapy for PTSD, Egyptian Psychotherapist Association.', 'Marriage Counselling/Relations', 3, 'manal@gmail.com', '789789', 'manal.jpg', 'Accepted', 200, 'therapists/Resume.pdf'),
(4, ' Saad El Mahdy', 'Male', '1964-02-05', 'Researcher master in psychology ,Ain-shams university', 'Psychotic disorders', 5, 'saad@gmail.com', '742289', 'saad.jpg', 'Accepted', 650, 'therapists/my-cv.pdf'),
...
(6, ' Huda Radwan', 'Female', '1977-07-27', 'Schema Therapy Diploma From Institute for Schema Therapy of Switherland', 'Child disorders & Attention-Deficit Hyperactivity Disorder.', 9, 'huda@gmail.com', 'n475h', 'basma.jpg', 'Accepted', 380, 'therapists/my-cv.pdf');
...
--
ALTER TABLE `therapists`
  MODIFY `Therapist_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `patients`
  ADD CONSTRAINT `patients_ibfk_1` FOREIGN KEY (`Sub_ID`) REFERENCES `sub_plan` (`Sub_ID`);
...
ALTER TABLE `payment`
  ...
  ADD CONSTRAINT `payment_ibfk_2` FOREIGN KEY (`Sub_ID`) REFERENCES `sub_plan` (`Sub_ID`);
...
--
-- Constraints for table `sub_plan`
--
ALTER TABLE `sub_plan`
  ADD CONSTRAINT `sub_plan_ibfk_1` FOREIGN KEY (`Admin-ID`) REFERENCES `admin` (`Admin_ID`),
  ADD CONSTRAINT `sub_plan_ibfk_2` FOREIGN KEY (`Event_ID`) REFERENCES `events` (`Event_ID`),
  ADD CONSTRAINT `sub_plan_ibfk_3` FOREIGN KEY (`Group_ID`) REFERENCES `group_therapy` (`Group_ID`),
  ADD CONSTRAINT `sub_plan_ibfk_4` FOREIGN KEY (`Book_ID`) REFERENCES `book_discussion_club` (`Book_ID`);
